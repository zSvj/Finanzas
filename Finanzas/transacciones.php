...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Gestión de Transacciones</h1>
        <p class="text-center">Aquí puedes agregar y gestionar tus transacciones, así como ver el historial completo de tus registros.</p>
